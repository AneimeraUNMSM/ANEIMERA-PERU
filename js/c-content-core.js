...
window.ANEIMERA_CONTENT_DEFAULTS = {
  ...
  impactMetrics: [
    ...
    { value: "50+", label: "Proyectos Anuales", body: "Iniciativas de investigación y desarrollo a nivel nacional." },
    { value: "10k", label: "Horas de Capacitación", body: "Cursos, talleres y seminarios técnicos para nuestros miembros." },
  ],
  trustStrip: {
    label: "CONFÍAN EN LA RED",
    code: "REGISTRO_NACIONAL_06",
    logos: [
      { name: "UNI" },
      { name: "PUCP" },
      { name: "UNMSM" },
  ...
  partnership: {
    eyebrow: "POR QUÉ ALIARSE",
    title:   "Una sola red, tres formas de generar valor.",
    body:    "Diseñamos cada alianza alrededor de tus objetivos. Contratación, I+D o marca empleadora — armamos el plan en una semana.",
    cta:     "PROGRAMAR CONVERSACIÓN →",
    note:    "RESPUESTA < 48H",
    tiers: [
      ...
      { code: "T-02 · ESTRATÉGICO", name: "Estratégico", price: "Desde 4,800 USD / año",
        bullets: ["Logo en home + eventos","Pipeline directo (50/año)","4 charlas + 1 visita técnica","Co-branding de un congreso","Reporte trimestral"] },
  ...
  areas: [
    { title: "Ingeniería Mecánica", body: "Diseño, análisis y manufactura de sistemas térmicos y mecánicos avanzados." },
    { title: "Ingeniería Eléctrica", body: "Generación, transmisión y distribución de energía para el desarrollo sostenible." },
    { title: "Ingeniería Electrónica", body: "Innovación en sistemas de control, automatización y telecomunicaciones." },
    { title: "Ramas Afines", body: "Integración multidisciplinaria en mecatrónica, energía y tecnologías emergentes." },
  ],
  capitulos: [
